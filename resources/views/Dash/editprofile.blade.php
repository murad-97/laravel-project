        ...
        <section class="signup">
            ...
            <div class="container" style="margin:auto">
                <div class="signup-content">
                    <form method="post" action="{{route('profile.update',$dataadmin->id)}}" enctype="multipart/form-data"  id="signup-form"  class="signup-form">
                        @method('PUT')
                       @csrf
                        ...
                        <div class="form-group">	
                            <input type="number" class="form-input" name="id" value="{{ $dataadmin}}" placeholder="Number of admin"/>
                          
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" value="{{ $dataadmin }}" id="name" placeholder="Name"/>
                            {{-- <span style="color:red">@error('name'){{ $message }} @enderror</span><br><br> --}}
                        </div>
                       
                      
                        <div class="form-group">	
                            <input type="email" class="form-input" name="email" value="{{ $dataadmin}}" placeholder="Email"/>
